...
namespace fish {
	...
	public: 
		...
		void draw(); 
		void add_object(std::vector<float>& verticies, std::vector<float>& colours, std::vector<int>& indicies, std::vector<float>& texture_coordinates, const std::string& texture_name);
	private: 
